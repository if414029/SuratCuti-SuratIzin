...
/**
 * PegawaiSearch represents the model behind the search form about `backend\modules\kpgw\models\Pegawai`.
 */
class PegawaiSearch extends Pegawai
{
    ...
    {
        return [
            [['pegawai_id', 'ref_kbk_id', 'agama_id', 'jenis_kelamin_id', 'golongan_darah_id', 'kabupaten_id', 'jabatan_akademik_id', 'gbk_1', 'gbk_2', 'status_ikatan_kerja_pegawai_id', 'status_aktif_pegawai_id', 'status_marital_id', 'user_id', 'role_id', 'struktur_jabatan_id', 'kuota_cuti_tahunan_id', 'deleted'], 'integer'],
