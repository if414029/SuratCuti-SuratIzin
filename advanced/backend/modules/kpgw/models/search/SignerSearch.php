...
/**
 * SignerSearch represents the model behind the search form about `backend\modules\kpgw\models\Signer`.
 */
class SignerSearch extends Signer
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['signer_id', 'user_id', 'deleted'], 'integer'],
