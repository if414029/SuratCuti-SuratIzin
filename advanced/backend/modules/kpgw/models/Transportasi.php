...
/**
 * This is the model class for table "kpgw_r_transportasi".
 *
...
class Transportasi extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(SuratTugas::className(), ['transportasi_id' => 'transportasi_id']);
    }
}
